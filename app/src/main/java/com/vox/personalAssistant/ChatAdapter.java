...
public class ChatAdapter extends RecyclerView.Adapter {
    ...
    public ChatAdapter(ArrayList<Chatsmodel> chatsmodalArrayList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 1:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chatbot_reply, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        Chatsmodel chatsmodal = chatsmodalArrayList.get(position);
